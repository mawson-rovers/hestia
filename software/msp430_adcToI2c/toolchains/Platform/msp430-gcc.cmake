...
FUNCTION(add_platform_executable EXECUTABLE_NAME DEPENDENCIES)
    ...
    FOREACH(device ${DEVICES})
        ...
        SET_TARGET_PROPERTIES(
                ...
                LINK_FLAGS "-mmcu=${device} -Wl,-Map,${MAP_FILE}  ${EXTRA_LINKER_FLAGS} -L ${MSP430_TI_HEADERS_FOLDER} -T ${device}.ld"
        )
...
FUNCTION(add_platform_library LIBRARY_NAME LIBRARY_TYPE DEPENDENCIES)
    ...
    FOREACH(device ${DEVICES})
        ...
        SET_TARGET_PROPERTIES(
                ...
                COMPILE_FLAGS "-mmcu=${device}"
                LINK_FLAGS "-mmcu=${device} ${EXTRA_LINKER_FLAGS} -L ${MSP430_TI_COMPILER_FOLDER}/include -T ${device}.ld"
        )
