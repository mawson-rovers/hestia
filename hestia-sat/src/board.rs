...
const HEATER_V_HIGH: Sensor = Sensor::mounted("heater_v_high", SensorInterface::MSP430, 0x06);
const HEATER_V_LOW: Sensor = Sensor::mounted("heater_v_low", SensorInterface::MSP430, 0x07);
const HEATER_CURR: Sensor = Sensor::mounted("heater_curr", SensorInterface::MSP430, 0x08);
...
impl Board {
    ...
    pub fn read_sensors(&self, timestamp: DateTime<Utc>, board_id: u16) -> SensorData {
        return SensorData {
            timestamp,
            board_id,
